      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-white/60 backdrop-blur-sm rounded-3xl p-6 md:p-8 shadow-xl border border-white/40">
          ...
          <div className="mb-8 flex items-center justify-center gap-4">
            ...
            <div
              className={`h-1 w-16 ${
                currentStep === "form" ? "bg-green-600" : "bg-slate-300"
              }`}
            ></div>
            <div
              className={`flex items-center gap-2 ${
                currentStep === "form" ? "text-blue-600" : "text-slate-400"
              }`}
            >
              <div
                className={`w-8 h-8 rounded-full flex items-center justify-center font-bold ${
          ...
          {currentStep === "upload" && (
            <div className="space-y-6">
              <div className="text-center mb-6">
                ...
                <p className="text-slate-600">
                  Gambar harus diupload terlebih dahulu sebelum mengisi form
                </p>
              </div>
              {!imagePreview ? (
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-slate-600">
                      Silakan isi form di bawah untuk melengkapi resep
                    </p>
                  </div>
                  <button
                    type="button"
